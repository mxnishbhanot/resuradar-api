...
- `FREE_BUILDER_TEMPLATES` — comma-separated slugs (default `modern`). The product uses a single standard PDF layout; this list controls which slug(s) count as free for legacy API checks.
